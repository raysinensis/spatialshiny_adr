...
.introjs-helperLayer:after {
  ...
  fixedPanel(
    ...
    introBox(
      ...
      data.step = 1,
      data.intro = "Welcome to the Adrenal Gland Spatial Transcriptomics Atlas.<br><br>
        ...
        tabPanel(
          ...
          div(
            ...
            div(
              introBox(
                div(
                  selectInput("sel1", NULL, choices = slides, selected = "A_DAA003_4_H&E"),
                  style = "border-radius:0px;vertical-align:top;margin:0px;padding-top:10px;padding-bottom:-200px;width:200px;"
                ),
                data.step = 4,
            ...
            div(
              div(
                selectInput("sel2", NULL, choices = slides, selected = "A_DAA003_4"),
                style = "border-radius:0;pxvertical-align:top;margin:0px;padding-top:10px;padding-bottom:-900px;width:200px;"
              ),
              div(
